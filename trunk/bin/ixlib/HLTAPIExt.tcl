...
# HLTAPIExt.tcl --
#   This file implements the extension for HLTAPI

#package provide HLTExt 0.1
puts "HLTAPIExt.tcl Initialed"
	...
	proc interface_ping_control { args } {
		...
		for { set index 0 } { $index < $count } { incr index } {
			...
			foreach int $interface_handle {
				...
				puts "pingResultItem is $pingResult"
			}
