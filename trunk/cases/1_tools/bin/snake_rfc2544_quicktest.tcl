...
proc set_traffic {} {
    ...
    foreach obj [list $sg_tracking $sg_egressTracking] {
        ...
        # configuring the object that corresponds to /traffic/trafficItem:1/.../fieldOffset/stack:"fcs-4"
        set sg_stack $obj/fieldOffset/stack:"fcs-4"
        sg_commit
        set sg_stack [lindex [ixNet remapIds $sg_stack] 0]
        #config stack:"fcs-4"
        ...
        puts "COMPLETED: traffic stack:\"fcs-4\" settings"
    }
